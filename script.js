...
// Event listeners for social media icons in the home section
    ...
    document.querySelector('.home-sci .bx.bx-git-repo-forked').parentElement.addEventListener('click', function () {
        openSocialMediaLink('https://replit.com/@ahmadzidaan786'); // Your Replit Profile link
    });
...
document.getElementById('resumeBtn').addEventListener('click', function () {
    var resumeFileName = 'Syed_Zidaan_Ahmad_Resume.pdf'; // Make sure that you have your resume named as Syed_Zidaan_Ahmad_Resume.pdf and in the same directory as your codes
